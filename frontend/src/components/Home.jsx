...
const Home = () => {
    ...
    return (
      ...
      <div className='bg-primary-dark h-screen justify-center overflow-scroll pb-20'>
          ...
          <button className='bg-primary-light hover:bg-green text-primary-dark p-2 ml-5 rounded-lg' onClick={() => handleOrder()}>Ordenar por nome</button>
